...
pub async fn load_last_indexed_commits(pool: &PgPool, list_id: i32)
...
pub async fn save_last_indexed_commits(pool: &PgPool, list_id: i32, commits: &HashMap<i32, String>) -> Result<(), String> {
