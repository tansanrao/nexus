...
export type ThreadSearchPage = PublicSchemas["ThreadSearchPage"]
export type ThreadSearchHit = PublicSchemas["ThreadSearchHit"]
export type ThreadSearchThreadSummary = PublicSchemas["ThreadSearchThreadSummary"]
export type ThreadSearchParticipant = PublicSchemas["ThreadSearchParticipant"]
export type ThreadSearchScore = PublicSchemas["ThreadSearchScore"]
export type ThreadSearchHighlights = PublicSchemas["ThreadSearchHighlights"]
export type ThreadSearchParams = PublicSchemas["ThreadSearchParams"]
